...
insert into doctor values(6, 'Roberto', 'Leal', '1980-12-15', 'Male'::gender_t, 'General Medicine'::specialties_t,15000, 10);
insert into doctor values(7, 'Catalina', 'Elizondo', '1955-08-01', 'Female'::gender_t, 'Allergology'::specialties_t,10000, 8);
insert into doctor values(8, 'Roberta', 'Martinez', '1989-11-03', 'Female'::gender_t, 'Obstetrics'::specialties_t,10000, 5);
insert into doctor values(9, 'Karina', 'Guzman', '1985-04-05', 'Female'::gender_t, 'Gerontology'::specialties_t,10000, 10);
insert into doctor values(10, 'Mariana', 'Fernandez', '1990-12-06', 'Female'::gender_t, 'Cardiology'::specialties_t,10000, 8);
insert into doctor values(11, 'Javier', 'Martinez', '1970-12-05', 'Male'::gender_t, 'Radiology'::specialties_t,10000, 5);
insert into doctor values(12, 'Luis', 'Alvarez', '1969-09-04', 'Male'::gender_t, 'Traumatology'::specialties_t,10000, 10);
insert into doctor values(13, 'Carolina', 'Gutierrez', '1989-12-12', 'Female'::gender_t, 'Allergology'::specialties_t, 20000, 3);
insert into doctor values(14, 'Robertina', 'Ilegal', '1981-12-15', 'Male'::gender_t, 'General Medicine'::specialties_t,15000, 10);
insert into doctor values(15, 'Robert', 'Hills', '1985-11-12', 'Male'::gender_t, 'Pediatrics'::specialties_t,170000, 3);
insert into doctor values(16, 'William', 'Ham', '1979-11-06', 'Male'::gender_t, 'Pediatrics'::specialties_t,17800, 6);
insert into doctor values(17, 'Henry', 'Hampton', '1969-01-11', 'Male'::gender_t, 'Obstetrics'::specialties_t,17800, 6);
insert into doctor values(18, 'Paulina', 'Lozano', '1978-11-01', 'Female'::gender_t, 'Gerontology'::specialties_t,16860, 9);
insert into doctor values(19, 'Maria', 'Menendez', '1983-10-11', 'Female'::gender_t, 'Cardiology'::specialties_t,15490, 3);
insert into doctor values(20, 'Isabella', 'Hernandez', '1984-04-03', 'Female'::gender_t, 'Radiology'::specialties_t,17890, 5);
insert into doctor values(21, 'Obi-Wan', 'Kesibi', '1976-02-03', 'Male'::gender_t, 'Traumatology'::specialties_t,20030, 8);
